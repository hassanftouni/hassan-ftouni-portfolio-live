...
const socialLinks = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/hassan-ftouni-2a9716269',
    icon: Linkedin,
    description: 'Professional network',
  },
  {
    name: 'GitHub',
    url: 'https://github.com/HassanFtouni',
    icon: Github,
    description: 'Code repositories',
  },
  {
    name: 'Freelancer.com',
    url: 'https://www.freelancer.com/Hassanftouni',
    icon: Briefcase,
